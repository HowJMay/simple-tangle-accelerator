...
#define CHID                                                                   \
  "UANFAVTSAXZMYUWRECNAOJDAQVTTORVGJCCISMZYAFFU9EYLBMZKEJ9VNXVFFGUTCHONEYVWVU" \
  "TBTDJLO"
#define NEW_CHID                                                               \
  "ONMTPDICUWBGEGODWKGBGMLNAZFXNHCJITSSTBTGMXCXBXJFBPOPXFPOJTXKOOSAJOZAYANZZB" \
  "FKYHJ9N"
#define EPID                                                                   \
  "KI99YKKLFALYRUVRXKKRJCPVFISPMNCQQSMB9BGUWIHZTYFQOBZWYSVRNKVFJLSPPLPSFNBNRE" \
  "JWOR99U"
