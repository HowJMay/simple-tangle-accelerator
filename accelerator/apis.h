...
/**
 * @brief Return transaction hashes with given information such as bundle
 * hashes, addresses, tags, or approvees.
 *
 * Explore transaction hash with given transaction related information. This
 * would return a list of transaction hashes in json format.
 *
 * @param[in] service IRI node end point service
 ...
 *
 * Explore transaction hash information with given single transaction hash. This
 * would return whole transaction object details in json format instead of raw
 * trytes.
 *
 * @param[in] service IRI node end point service
 * @param[in] obj transaction hash in trytes
 * @param[out] json_result Result containing the only one transaction object in
 * json format
 *
 * @return
 * - SC_OK on success
